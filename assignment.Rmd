---
title: "1053835_penguins_assignment"
...
penguins_scatter_plot <- remove_NAs_from_flipper_length(penguins_now_clean)
...
NB: the file containing my code for Question 4 is called 'penguins_assignment.Rmd', while the file containing my answers to all questions is called 'assignment.Rmd'. 
...
## Question 5: Download someone else's example from Question 04.
...
Additionally, my partner could have created functions for saving their plot as a png or svg file. This would make their work more reusable, as it is easier to save multiple plots as figures using a custom function rather than having to copy out the ‘agg_png()’ and ‘svglite()’ functions and specify their inputs every time. 
